...
namespace DMO {
	...
	class DMOTriClass : public DMOBaseClass {
	public:
		DMOTriClass() = delete;
		DMOTriClass(DMOMeshTri& dmo_mesh_, QualityCriterium qualityCriterium_ = QualityCriterium::MEAN_RATIO, const float gridScale_ = 0.5f, int n_iter_ = 30);
