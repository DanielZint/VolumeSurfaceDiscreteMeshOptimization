...
namespace DMO {
	...
	class DMOQuadClass : public DMOBaseClass {
	public:
		DMOQuadClass() = delete;
		DMOQuadClass(DMOMeshQuad& dmo_mesh_, QualityCriterium qualityCriterium_ = QualityCriterium::MEAN_RATIO, const float gridScale_ = 0.5f, int n_iter_ = 30);
