...
namespace Graphics {
	...
	// ### DrawableQuadMesh ####################################################### //
	// ######################################################################## //
	class DrawableQuadMesh : public DrawableMesh {
	public:

		DrawableQuadMesh(const glm::vec4& color);

		DrawableQuadMesh(const DrawableQuadMesh& copy) = delete;
		DrawableQuadMesh& operator=(const DrawableQuadMesh& assign) = delete;

		virtual ~DrawableQuadMesh();
	...
	// ### DrawableInteropMesh ################################################ //
	// ######################################################################## //
	class DrawableInteropQuadMesh : public DrawableQuadMesh {
	public:

		DrawableInteropQuadMesh(const glm::vec4& color);

		DrawableInteropQuadMesh(const DrawableInteropQuadMesh& copy) = delete;
		DrawableInteropQuadMesh& operator=(const DrawableInteropQuadMesh& assign) = delete;

		virtual ~DrawableInteropQuadMesh();
